#
#  Be sure to run `pod spec lint TagWorks.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "obzen" => "obzen-rnd@obzen.com" }
  ...
  spec.source	    = { :http => "https://support.obzen.com/nexus/repository/releases/com/obzen/tagworks/tagworks-v1-ios-xcframework/1.1.35/tagworks-v1-ios-xcframework-1.1.35.zip"}
